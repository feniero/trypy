...
st.wirte("Here we analyze the distribution rolling returns on a given time.")
st.wirte("Let's try to answer the final question: How it is gone if I bought it some time ago?")
